...
import { MuiCardContent as darkMuiCardContent } from "./dark/MuiCardContent";
...
import { MuiCardContent as lightMuiCardContent } from "./light/MuiCardContent";
...
export const darkTheme: Theme = createTheme({
  ...
  components: {
    ...
    MuiCardContent: darkMuiCardContent,
...
export const lightTheme: Theme = createTheme({
  ...
  components: {
    ...
    MuiCardContent: lightMuiCardContent,
